  ...
  render() {
    return (
      <div className="competence">
        <h1 className="col-12 m-0 mb-3 p-0 text-center">Compétence</h1>
        <div className="col-12 m-0 p-0 row">
          <div className="col-6 p-0 bloc">
            <h2 className="col-11 offset-1 p-0">Technologies</h2>
          ...
          <div className="col-6 p-0 bloc">
            <h2 className="col-11 offset-1 p-0">Outils</h2>
